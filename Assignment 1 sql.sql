...
/* 17. Write a query to display the name (first_name, last_name) and department ID of all
...
/* 19. Write a query to display the name (first_name, last_name) and hire date for all
...
employees whose name starts with the letters 'A', 'J' or 'M'. Give each column an appropriate label.
...
/*35. Write a query to display the first eight characters of the employees' first names and
